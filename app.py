...
def main():
    ...
    year = st.number_input('Year', min_value=1900, max_value=2023, step=5)
    ...
    if st.button('Predict Price'):
        ...
        # Add color to the success message
         ...
         colored_message = f'<span style="color: lightblue; font-size: 30px; font-weight: bold;">{success_message}</span>'
